...
function handle(message) {
  switch (message.method) {
    ...
    case 'workspace/symbol':
      // Two matches pin the suite-config maxLocations: 1 omission marker.
      process.stdout.write(frame({
        id: message.id,
        result: [
          { name: 'answer', kind: 12, location: location(0) },
          { name: 'answerAll', kind: 12, containerName: 'ns', location: location(1) },
        ],
      }))
      break
    case 'shutdown':
