...
来源：[`packages/core/session/src/types.ts:419`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:427`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:449`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:480`](../packages/core/session/src/types.ts)
...
来源：[`packages/interaction/user-approval/src/types.ts:66`](../packages/interaction/user-approval/src/types.ts)
...
来源：[`packages/interaction/user-approval/src/types.ts:78`](../packages/interaction/user-approval/src/types.ts)
...
来源：[`packages/core/session/src/types.ts:415`](../packages/core/session/src/types.ts)
...
来源：[`packages/session/session-log-deepseek/src/types.ts:82`](../packages/session/session-log-deepseek/src/types.ts)
...
来源：[`packages/todo/tool-todo/src/types.ts:35`](../packages/todo/tool-todo/src/types.ts)
...
[`event:agent/inbox/spliced.data.inserted[0].source[20].entries[0]`](#persistence-type-eventagentinboxspliceddatainserted0source20entries0) 的数组。
...
来源：[`packages/core/session/src/types.ts:223`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:146`](../packages/llm/llm/src/types.ts)
...
来源：[`packages/core/session/src/types.ts:297`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:299`](../packages/core/session/src/types.ts)
...
来源：[`packages/core/session/src/types.ts:373`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:24`](../packages/core/tools/src/types.ts)
...
来源：[`packages/core/session/src/types.ts:286`](../packages/core/session/src/types.ts) · [`packages/deliverables/workspace-changes/src/types.ts:106`](../packages/deliverables/workspace-changes/src/types.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `action` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[19].changes[0].action`](#persistence-type-eventagentinboxspliceddatainserted0source19changes0action) |
| `digest` | 可选 | `string` |
| `path` | 必需 | `string` |
| `scope` | 必需 | `string` |
...
| `changes` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[19].changes`](#persistence-type-eventagentinboxspliceddatainserted0source19changes) |
| `form` | 必需 | `"instructions"` |
...
来源：[`packages/core/session/src/types.ts:100`](../packages/core/session/src/types.ts)
...
来源：[`packages/memory/memory/src/types.ts:12`](../packages/memory/memory/src/types.ts)
...
| `kind` | 必需 | `"dsh-memory"` |
| `project` | 可选 | `string` |
| `scope` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[18].scope`](#persistence-type-eventagentinboxspliceddatainserted0source18scope) |
| `version` | 必需 | `2` |
...
来源：[`packages/skill/skill/src/index.ts:164`](../packages/skill/skill/src/index.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `entries` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[20].entries`](#persistence-type-eventagentinboxspliceddatainserted0source20entries) |
| `form` | 必需 | `"catalog"` |
...
来源：[`packages/subagent/subagent/src/continuation.ts:73`](../packages/subagent/subagent/src/continuation.ts)
...
来源：[`packages/subagent/subagent/src/continuation.ts:82`](../packages/subagent/subagent/src/continuation.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `form` | 必需 | `"relay"` |
| `kind` | 必需 | `"subagent-report"` |
| `senderSessionId` | 必需 | `string` |
...
来源：[`packages/todo/tool-todo/src/types.ts:23`](../packages/todo/tool-todo/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `activeForm` | 可选 | `string` |
| `content` | 必需 | `string` |
