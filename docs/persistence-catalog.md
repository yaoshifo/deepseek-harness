...
|---|---|---|---|
| `SessionHeader` | header | `9a395f3ba189e903c40ce31b559abac848ec18dbaae43a42d331021cf2d327bd` | [`packages/core/session/src/types.ts#SessionHeader`](#persistence-type-packagescoresessionsrctypestssessionheader) |
| `JsonlHeaderLine` | header | `5116fff8ba515a214ed0aaec3e73fc1f1b1f00ce8a3fa15456ebc225177526a2` | [`packages/session/session-persistence-jsonl/src/format.ts#HeaderLine`](#persistence-type-packagessessionsession-persistence-jsonlsrcformattsheaderline) |
...
| `event:agent/inbox/spliced` | event | `0231bd09c6f879c30a47b10af3559db7228f07a808ff86948c280a9379501cd8` | [`event:agent/inbox/spliced`](#persistence-type-eventagentinboxspliced) |
...
| `event:approval/decided` | event | `3dd458f07d89f180cfb1a88b77d2c68b9b023c3691aa83d881c15dce5bb8e0ad` | [`event:approval/decided`](#persistence-type-eventapprovaldecided) |
...
| `event:session/title-llm-request` | event | `dc40a9daab5b13aa75d676b98c5a67e60977a42569f8350e5757afc28b416f71` | [`event:session/title-llm-request`](#persistence-type-eventsessiontitle-llm-request) |
...
| `event:todo/write` | event | `14826b815dfc9dc3c3b9c48ee339ae9279d40d2791504d3c0ac8ada16978d480` | [`event:todo/write`](#persistence-type-eventtodowrite) |
...
| `event:user/message` | event | `973d20630edf0e9001df7d215c59da2777401c4a68b5ff87fa8ff87716c3c8ba` | [`event:user/message`](#persistence-type-eventusermessage) |
...
Sources: [`packages/core/session/src/types.ts:419`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:427`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:449`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:480`](../packages/core/session/src/types.ts)
...
Source: [`packages/interaction/user-approval/src/types.ts:66`](../packages/interaction/user-approval/src/types.ts)
...
Source: [`packages/interaction/user-approval/src/types.ts:78`](../packages/interaction/user-approval/src/types.ts)
...
Source: [`packages/session/session-log-deepseek/src/types.ts:82`](../packages/session/session-log-deepseek/src/types.ts)
...
Source: [`packages/todo/tool-todo/src/types.ts:35`](../packages/todo/tool-todo/src/types.ts)
...
<a id="persistence-type-coordinator"></a>

### `"coordinator"`

SHA-256: `e5490e869106eaf79c1b4f47ada3ef64d1a9af9b29d084bc9aa6bf83bc3ccdc9`
...
<a id="persistence-type-dsh-memory"></a>

### `"dsh-memory"`

SHA-256: `757a94bc59bd584f3a6d7d0366909d85938397613b2128ef3fa5adcdad0406ab`
...
SHA-256: `0231bd09c6f879c30a47b10af3559db7228f07a808ff86948c280a9379501cd8`
...
SHA-256: `682d909fbe2314f2475ad875ea93ee0dde3e1f90d768f64a19bc421f2d57733d`
...
SHA-256: `b85da04559b76f457fcfbab572de41e8aaa64dd13f80e12a12a7d1be9ac91106`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source18scope"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[18].scope`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source19changes"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[19].changes`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source19changes0action"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[19].changes[0].action`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source20entries"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[20].entries`

SHA-256: `aba175fb20ffc71112c55efe70458ff5d7dbfb83501892b4ba8d077f0ea5d7ba`

Array of [`event:agent/inbox/spliced.data.inserted[0].source[20].entries[0]`](#persistence-type-eventagentinboxspliceddatainserted0source20entries0).

<a id="persistence-type-eventagentinboxspliceddatainserted0source20entries0"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[20].entries[0]`
...
Sources: [`packages/interaction/user-approval/src/types.ts:66`](../packages/interaction/user-approval/src/types.ts)
...
SHA-256: `3dd458f07d89f180cfb1a88b77d2c68b9b023c3691aa83d881c15dce5bb8e0ad`
...
SHA-256: `4c8785a2d37c9c97174cf6c320966ab5cf6fef7af3644a0c3fb9238874d671c6`

Sources: [`packages/interaction/user-approval/src/types.ts:78`](../packages/interaction/user-approval/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:223`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:146`](../packages/llm/llm/src/types.ts)
...
Sources: [`packages/session/session-log-deepseek/src/types.ts:82`](../packages/session/session-log-deepseek/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:415`](../packages/core/session/src/types.ts)
...
SHA-256: `dc40a9daab5b13aa75d676b98c5a67e60977a42569f8350e5757afc28b416f71`
...
SHA-256: `03c4042f827536533f20a68a01e529d42f0c17eae41aeac9c04abce131540314`
...
Sources: [`packages/core/session/src/types.ts:297`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:299`](../packages/core/session/src/types.ts)
...
SHA-256: `14826b815dfc9dc3c3b9c48ee339ae9279d40d2791504d3c0ac8ada16978d480`
...
SHA-256: `377bda3f56e3b44129a5525093a533a9f154281670ac9ffe424c79f20ecf619d`

Sources: [`packages/todo/tool-todo/src/types.ts:35`](../packages/todo/tool-todo/src/types.ts)
...
SHA-256: `e7a9dc1595382c7f8a6cb2c2938756787b13ce516af06497013913118325c7ad`
...
Sources: [`packages/core/session/src/types.ts:373`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:24`](../packages/core/tools/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:215`](../packages/core/session/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:286`](../packages/core/session/src/types.ts) · [`packages/deliverables/workspace-changes/src/types.ts:106`](../packages/deliverables/workspace-changes/src/types.ts)
...
SHA-256: `973d20630edf0e9001df7d215c59da2777401c4a68b5ff87fa8ff87716c3c8ba`
...
<a id="persistence-type-global"></a>
...
SHA-256: `38cbb6f0cfcbf1c653014caa9715b7e19383c5c29291315732c8374fda548f7d`
...
<a id="persistence-type-oneshot"></a>

### `"oneshot"`

SHA-256: `af7d5793a94ba6b0ee24d2245ab411e200899643c164e0ea2842a302df0d86c5`
...
| Property | Presence | Type |
|---|---|---|
| `action` | required | [`event:agent/inbox/spliced.data.inserted[0].source[19].changes[0].action`](#persistence-type-eventagentinboxspliceddatainserted0source19changes0action) |
...
| `changes` | required | [`event:agent/inbox/spliced.data.inserted[0].source[19].changes`](#persistence-type-eventagentinboxspliceddatainserted0source19changes) |
| `form` | required | `"instructions"` |
...
Sources: [`packages/core/session/src/types.ts:271`](../packages/core/session/src/types.ts)
...
SHA-256: `9a395f3ba189e903c40ce31b559abac848ec18dbaae43a42d331021cf2d327bd`

Sources: [`packages/core/session/src/types.ts:100`](../packages/core/session/src/types.ts)
...
| `origin` | optional | [`JsonlHeaderLine.origin`](#persistence-type-jsonlheaderlineorigin) |
...
Sources: [`packages/core/session/src/types.ts:449`](../packages/core/session/src/types.ts)
...
SHA-256: `70cc1355e2d45ae8725350debe06539d672992c63196fb18faf4fb13135f669c`
...
SHA-256: `9d435e6c983c14195bf3ea46ef034a3ad82ddaa8b2ed68e022675cdae94666c7`
...
- [`packages/memory/memory/src/types.ts#DshMemorySource`](#persistence-type-packagesmemorymemorysrctypestsdshmemorysource)
...
- [`packages/subagent/subagent/src/continuation.ts#SubagentReportMessageSource`](#persistence-type-packagessubagentsubagentsrccontinuationtssubagentreportmessagesource)
- [`packages/subagent/subagent/src/continuation.ts#CoordinatorMessageSource`](#persistence-type-packagessubagentsubagentsrccontinuationtscoordinatormessagesource)
...
SHA-256: `2e7e1718aac5b86231c9a47ccdb169c2bcb76fed64580058ab0037900ad0ab36`
...
<a id="persistence-type-packagesmemorymemorysrctypestsdshmemorysource"></a>

### `packages/memory/memory/src/types.ts#DshMemorySource`

SHA-256: `2b301dbeaa28378107c85db28722225637b350ba293967c7b86b9b1c3aefed37`

Sources: [`packages/memory/memory/src/types.ts:12`](../packages/memory/memory/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `digest` | required | `string` |
| `kind` | required | `"dsh-memory"` |
| `project` | optional | `string` |
| `scope` | required | [`event:agent/inbox/spliced.data.inserted[0].source[18].scope`](#persistence-type-eventagentinboxspliceddatainserted0source18scope) |
| `version` | required | `2` |
...
SHA-256: `5116fff8ba515a214ed0aaec3e73fc1f1b1f00ce8a3fa15456ebc225177526a2`
...
SHA-256: `b8d99d4a3f8a3e5b061187a8a3d560d2241343165eeff2d7b63735d19574f5e2`
...
Sources: [`packages/skill/skill/src/index.ts:164`](../packages/skill/skill/src/index.ts)
...
| Property | Presence | Type |
|---|---|---|
| `entries` | required | [`event:agent/inbox/spliced.data.inserted[0].source[20].entries`](#persistence-type-eventagentinboxspliceddatainserted0source20entries) |
| `form` | required | `"catalog"` |
...
<a id="persistence-type-packagessubagentsubagentsrccontinuationtscoordinatormessagesource"></a>

### `packages/subagent/subagent/src/continuation.ts#CoordinatorMessageSource`

SHA-256: `bd3e1e18c19dbcf0f9a00d2d3fd5578d534c3116c5d178e7d03d1282cf33f416`

Sources: [`packages/subagent/subagent/src/continuation.ts:73`](../packages/subagent/subagent/src/continuation.ts)

| Property | Presence | Type |
|---|---|---|
| `form` | required | `"relay"` |
| `kind` | required | `"coordinator"` |
| `senderSessionId` | required | `string` |

<a id="persistence-type-packagessubagentsubagentsrccontinuationtssubagentreportmessagesource"></a>

### `packages/subagent/subagent/src/continuation.ts#SubagentReportMessageSource`

SHA-256: `9ae1ea50ee2204600a7e618f5acd516e70b753d3989f3a32138707218632ff6c`

Sources: [`packages/subagent/subagent/src/continuation.ts:82`](../packages/subagent/subagent/src/continuation.ts)

| Property | Presence | Type |
|---|---|---|
| `form` | required | `"relay"` |
| `kind` | required | `"subagent-report"` |
| `senderSessionId` | required | `string` |
...
SHA-256: `42e95ec132cd0157bf16b6a352915acb9435f69222ea9cd8e377ccc854473147`

Sources: [`packages/todo/tool-todo/src/types.ts:23`](../packages/todo/tool-todo/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `activeForm` | optional | `string` |
...
Sources: [`packages/core/session/src/types.ts:451`](../packages/core/session/src/types.ts)
...
<a id="persistence-type-subagent-report"></a>

### `"subagent-report"`

SHA-256: `bf781de509386d1f8396fa40d5dfb676f85249c38146f33f90962e27e275f9a2`
