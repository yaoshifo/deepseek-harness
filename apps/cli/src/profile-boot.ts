 ...
 * lifecycle (a deployment can still freeze watching via
 * `DSH_CONFIG_HMR_DISABLED`), and wire fail-loud plus bounded shutdown.
 *
...
export async function runProfile(options: RunProfileOptions): Promise<{ ctx: Context; shutdown: ProcessShutdown }> {
  ...
  // DSH_CONFIG_HMR_DISABLED freezes watching for a live profile the same way.
