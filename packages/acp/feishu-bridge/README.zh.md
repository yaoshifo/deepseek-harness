...
- **Go 命令清单仅部分移植**：`/shell` 与 `!` 快捷前缀已落地（Agent Note `feature/2026-08-22-feishu-bridge-shell-command.md`），但 Go 52 条 builtin 命令中约 34 条（`/help`、`/whoami`、`/history`、`/show`、`/diff`、`/ps` 等）未注册；`message_help` i18n 文案仍在宣传它们。命令清单系统性 diff 与逐条迁移/裁剪裁定挂 M8。
