...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'list_subagent_models', 'lsp', 'memory_delete', 'memory_index', 'memory_list',
      'memory_read', 'memory_write', 'plugin_manager', 'present', 'pwsh', 'pwsh', 'ralph',
      'read', 'read_image', 'read_mcp_resource', 'report', 'run_code', 'schedule_create', 'schedule_delete',
