...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'ContextBreakdownValue',
    declaration: 'export interface ContextBreakdownValue {\n    systemTokens: number;\n    toolsTokens: number;\n    messageTokens: number;\n}',
  },
  {
    name: 'ContextFormed',
  ...
  {
    name: 'ContextHeadersValue',
    declaration: 'export interface ContextHeadersValue {\n    headers: HeaderRecordValue[];\n}',
  },
  {
    name: 'ContextPressureValue',
    declaration: 'export interface ContextPressureValue {\n    pressureTokens?: number;\n    projectedTokens?: number;\n    contextWindow?: number;\n}',
  },
  {
  ...
  {
    name: 'CostBucketTotals',
    declaration: 'export interface CostBucketTotals {\n    uncached: number;\n    output: number;\n    cacheRead: number;\n    cacheWrite: number;\n}',
  },
  {
    name: 'CostFamilyUsage',
    declaration: 'export interface CostFamilyUsage {\n    peak?: CostBucketTotals;\n    off?: CostBucketTotals;\n}',
  },
  {
  ...
  },
  {
    ...
    declaration: 'export interface CurrentComposition extends SixBuckets {\n    total: number;\n}',
  },
  {
  ...
  {
    name: 'HeaderRecordValue',
    declaration: 'export interface HeaderRecordValue {\n    seq: number;\n    time: number;\n    tools: HeaderToolValue[];\n}',
  },
  {
    name: 'HeaderToolValue',
    declaration: 'export interface HeaderToolValue {\n    name: string;\n    tokens: number;\n    plugin?: string;\n}',
  },
  {
    name: 'I18n',
  ...
  {
    name: 'RequestRecord',
    declaration: 'export interface RequestRecord extends SixBuckets {\n    turn?: number;\n    step?: number;\n    time: number;\n    seq: number;\n    total: number;\n    prompt?: number;\n    cacheRead?: number;\n    output?: number;\n}',
  },
  {
  ...
  {
    name: 'SessionCostUsage',
    declaration: 'export interface SessionCostUsage {\n    flash?: CostFamilyUsage;\n    pro?: CostFamilyUsage;\n}',
  },
  {
  ...
  {
    name: 'SixBuckets',
    declaration: 'export interface SixBuckets {\n    system: number;\n    tools: number;\n    user: number;\n    inject: number;\n    assistant: number;\n    tool: number;\n}',
  },
  {
    name: 'SkillCandidate',
  ...
  {
    name: 'TimelineEvent',
    declaration: 'export interface TimelineEvent {\n    seq: number;\n    time: number;\n    kind: \'compaction\' | \'prune\' | \'inject\' | \'model\' | \'mode\';\n    form?: string;\n    tokens?: number;\n    count?: number;\n    sub?: string;\n    name?: string;\n    detail?: string;\n    from?: string;\n    to?: string;\n    fromTurn?: number;\n    fromStep?: number;\n    turn?: number;\n    step?: number;\n}',
  },
  {
  ...
  {
    name: 'TokenUsageValue',
    declaration: 'export interface TokenUsageValue {\n    uncachedInputTokens: number;\n    outputTokens: number;\n    cacheReadTokens: number;\n    cacheWriteTokens: number;\n}',
  },
  {
    name: 'ToolCallKind',
