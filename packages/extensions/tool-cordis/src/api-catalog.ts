...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'async mount(agentCtx: Context): Promise<void>',
        ...
        parameters: [{ name: 'agentCtx', description: 'the unpublished agent\'s scoped creation context.' }],
      },
      {
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  },
  {
    ...
    declaration: 'export type ContinuableSetupContribution = (childCtx: Context) => (() => void) | Promise<(() => void) | void>;',
  },
  {
  ...
  {
    name: 'ProgressStatus',
    declaration: 'export interface ProgressStatus {\n    state: \'running\' | \'completed\' | \'failed\' | \'thinking\' | \'waiting\' | \'approved\' | \'rejected\' | \'answered\' | \'cancelled\';\n    ts: string;\n    toolCallSeq: number;\n    pendingSubtasks?: number;\n}',
  },
  {
