...
- Tool-name routing stays split by composition scope: generic repository copies (presets, dsh-base bundle) are tool-neutral; the bridge bundle patch — a repository copy scoped to bridge compositions — names the tool. The [parallel scheduling](2026-08-09-parallel-subagent-delegations.md) and [unattended native seam](2026-08-24-feishu-bridge-native-unattended-subtasks.md) mechanisms are untouched.
