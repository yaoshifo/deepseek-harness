...
- Both edits landed identically in all five copies then current: dsh-base bundle patch, bridge bundle patch ([bundle-patch ownership](../architecture/2026-09-01-feishu-bridge-plan-mode-guidance-in-bundle-patch.md)), and the three preset copies. Partially superseded 2026-09-06: base and the three presets returned to upstream verbatim, so the live guidance lives only in the bridge patch, whose lockstep gate pins the fork deltas ([fork conflict-surface reduction](../process/2026-09-06-fork-conflict-surface-reduction.md)).
